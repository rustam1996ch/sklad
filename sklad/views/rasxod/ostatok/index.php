...
<div class="sell-ostatok-product">
    ...
    <?php endif?>
     <?= GridView::widget([
        ...
        // 'panelBeforeTemplate' => '
        //     {toolbarContainer}
        //     ' . Html::a('Все', ['/rasxod/ostatok-total'], ['class' => 'btn btn-success', 'style' => 'float: right; margin-right: 2px']) . '.' . Html::a('Буфер Остаток', ['/buffer/ostatok-product'], ['class' => 'btn btn-success', 'style' => 'float: right; margin-right: 2px']) . '
