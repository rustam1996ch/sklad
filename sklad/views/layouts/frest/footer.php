...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-left d-inline-block">2020 &copy; Art. Int</span>
        <!--        <span class="float-right d-sm-inline-block d-none">-->
        <!--            Crafted with<i class="bx bxs-heart pink mx-50 font-small-3"></i>by-->
        <!--            <a class="text-uppercase" href="https://1.envato.market/pixinvent_portfolio"target="_blank">Int. Art</a>-->
        <!--        </span>-->
