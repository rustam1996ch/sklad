                ...
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Email"><i class="ficon bx bx-envelope"></i></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Chat"><i class="ficon bx bx-chat"></i></a></li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Todo"><i class="ficon bx bx-check-circle"></i></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Calendar"><i class="ficon bx bx-calendar-alt"></i></a>
                        </li>
<!--                         <li class="nav-item d-none d-lg-block">
                         ...
                         <li class="nav-item nav-toggle">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top">
                                <div class="custom-control custom-switch custom-switch-secondary mr-2 mb-1">
                                    <input type="checkbox" class="custom-control-input layout-name" name="layoutOptions" value="true" id="customSwitch15">
                            ...
                            <li class="scrollable-container media-list"><a class="d-flex justify-content-between"
                                    ...
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0"><img
                                                        src="<?= bu('themes/frest/app-assets/images/portrait/small/avatar-s-11.jpg') ?>"
                                ...
                                <div class="d-flex justify-content-between read-notification cursor-pointer">
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0"><img
                                                        src="<?= bu('themes/frest/app-assets/images/portrait/small/avatar-s-16.jpg') ?>"
                                                        alt="avatar" height="39" width="39"></div>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="d-flex justify-content-between cursor-pointer">
                                    <div class="media d-flex align-items-center py-0">
                                        <div class="media-left pr-0"><img class="mr-1"
                                                                          src="<?= bu('themes/frest/app-assets/images/icon/sketch-mac-icon.png') ?>"
                                                                          alt="avatar" height="39" width="39"></div>
                                        <div class="media-body">
                                ...
                                <div class="d-flex justify-content-between read-notification cursor-pointer">
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0"><img
                                                        src="<?= bu('themes/frest/app-assets/images/portrait/small/avatar-s-4.jpg') ?>"
                                                        alt="avatar" height="39" width="39"></div>
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item"
                            ...
                            <div class="dropdown-divider mb-0"></div>
                               <!-- logout -->
                               <?= Html::a('<i class="bx bx-power-off mr-50"></i> Logout', ['/site/logout'],['class' => 'dropdown-item', 'data' => ['method' => 'post']]) ?>
                        </div>
                    </li>
                </ul>
            </div>
